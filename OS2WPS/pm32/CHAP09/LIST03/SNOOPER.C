...
int main( void)
{
    ...
    // class time critical, level +10
    if( DosSetPriority( PRTYS_THREAD, PRTYC_TIMECRITICAL, +10, 0))
                                ...
                                MPARAM mp2)
{
    ...
    switch( msg)
    {
        ...
        case WM_MOUSEMOVE:
        {
            ...
            *snoop.szClass = '\0' ;
            ...
            if( lLen < 4 && *snoop.szClass == '#')
            {
                ...
                if( ( ulClass = (ULONG)atol( snoop.szClass + 1)) > 0x28)
                    ulClass = 100 ;
            ...
            *snoop.szParentClass = '\0' ;
            ...
            if( lLen < 4 && *snoop.szParentClass == '#')
            {
                ...
                if( ( ulClass = (ULONG)atol( snoop.szParentClass + 1)) > 0x28)
                    ulClass = 100 ;
                WinLoadString(  HAB( hwnd), NULLHANDLE,
                                ulClass,
                                sizeof szClass, szClass) ;
            ...
            *snoop.szOwnerClass = '\0' ;
            ...
            {
                WinLoadString(  HAB( hwnd), NULLHANDLE,
                                (ULONG)atol( snoop.szOwnerClass + 1),
                                sizeof szClass, szClass) ;
            ...
            snoop.pri = ptib -> tib_ptib2 -> tib2_ulpri ;
        ...
        case WM_PAINT:
        {
            ...
            pt.y -= ITEMHEIGHT ;
            lLen = (LONG) sprintf( szString, "Priority class :%d - Priority level: %d", HIBYTE( snoop.pri), LOBYTE( snoop.pri)) ;
            GpiCharStringAt( hps, &pt, lLen, szString) ;
