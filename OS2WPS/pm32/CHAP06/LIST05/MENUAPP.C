// MENUAPP.C - Changing menuitem attributes
// Listing 06-05
        ...
        case WM_COMMAND:
            switch( COMMANDMSG( &msg )->cmd )
            {
                ...
                case MN_NEW:
                {
                    ...
                    WinSendMsg( hmenu, MM_SETITEMATTR,
                                MPFROM2SHORT( MN_NEW, TRUE),
                                MPFROM2SHORT( MIA_CHECKED, (short)(fValue) ? MIA_CHECKED : ~MIA_CHECKED)) ;
                }
                    break ;
                ...
                default:
                {
                    ...
                    WinMessageBox(  HWND_DESKTOP, hwnd,
                                    szString, "Message Received", 0, MB_OK) ;
                }
                    break ;
